...
class ILADE(nn.Module):
    def __init__(self, config_text, norm_nc, label_nc, embedding_nc):
        super().__init__()
        ...
        middle_nc = 64
        self.embedding_gamma_0 = nn.Linear(embedding_nc, middle_nc)
        self.embedding_gamma_1 = nn.Linear(middle_nc, norm_nc)
        self.embedding_beta_0 = nn.Linear(embedding_nc, middle_nc)
        self.embedding_beta_1 = nn.Linear(middle_nc, norm_nc)
        self.embedding_actv = nn.ReLU()
